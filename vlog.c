       ...
       ...)
{
    ...
    switch (level) {
        case VLOG_FATAL:
            lvlstr = VLOG_STR_FATAL " ";
            break;
        case VLOG_ALERT:
            lvlstr = VLOG_STR_ALERT " ";
            break;
        case VLOG_CRITICAL:
            lvlstr = VLOG_STR_CRIT " ";
            break;
        case VLOG_ERROR:
            lvlstr = VLOG_STR_ERR " ";
            break;
        case VLOG_WARNING:
            lvlstr = VLOG_STR_WARN " ";
            break;
        case VLOG_NOTICE:
            lvlstr = VLOG_STR_NOTE " ";
            break;
        case VLOG_INFO:
            lvlstr = VLOG_STR_INFO " ";
            break;
        case VLOG_DEBUG:
            lvlstr = VLOG_STR_DEBUG " ";
            break;
        case VLOG_TRACE:
            lvlstr = VLOG_STR_TRACE " ";
            break;
        default:
            lvlstr = VLOG_STR_NONE " ";
            break;
    }
